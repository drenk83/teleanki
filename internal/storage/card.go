...
type CardRepository interface {
	Create(ctx context.Context, userID int64, card *domain.Card) (*domain.Card, error)
	CreateMany(ctx context.Context, userID, deckID int64, cards []domain.Card) error
	...
	Update(ctx context.Context, userID int64, card *domain.Card) error
