...
• Лимит на день ограничивает, сколько карточек ты оценишь за сутки (UTC) в режиме «Начать».
...
Для quiz нужны choices (2–6); среди них обязан быть back. Совпадение без учёта регистра.
